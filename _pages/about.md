...
(* indicates equal contribution; I am the first author for the first two papers)

1. **On the Perception Bottleneck of VLMs for Chart Understanding** (2025, Arxiv)  
   **Junteng Liu**, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He

2. **SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond** (2025, Arxiv)  
